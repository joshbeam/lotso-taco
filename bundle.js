...
var Control = React.createClass({displayName: "Control",
	...
	render: function() {
		return (
			React.createElement("button", {className: "control", onClick: this.changedSlide}, this.props.to === -1 ? 'Previous' : 'Next')
		);
	}
});
...
},{"../lib/shortwave/shortwave":5,"react":162}],2:[function(require,module,exports){
var React = require('react');
	...
	render: function() {
		return (
			React.createElement("div", {className: "controls"}, 
				React.createElement(Control, {to: -1}), 
				React.createElement(Control, {to: 1})
			)
		);
	}
...
},{"./Control.react":1,"react":162}],3:[function(require,module,exports){
var React = require('react');
		...
		return (
			React.createElement("div", {className: "pane"}, 
				this.props.tacos.map(function(url, i) {
					return React.createElement("img", {src: url, key: i, className:  this.props.showing === i ? '' : 'hidden'});
				}.bind(this))
			)
		);
	}
	...
	render: function() {
		return (
			React.createElement("div", {className: "slider"}, 
				...
				React.createElement(Pane, {tacos: this.props.tacos, showing: this.state.showing}), 
...
},{"../lib/shortwave/shortwave":5,"./Controls.react":2,"./Pane.react":3,"react":162}],5:[function(require,module,exports){
'use strict';
...
React.render(React.createElement(Slider, {title: "Lotso Taco", tacos: TacoStore.getAll()}), document.getElementById('slider'));

},{"./components/Slider.react":4,"./stores/tacos.store":163,"react":162}],7:[function(require,module,exports){
